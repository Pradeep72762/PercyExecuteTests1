...
beforeEach('Launch alelo-enterprisepartner Page : ', function () {
    ...
    helperMethodObj.visitPage(Cypress.env('alelo-enterprisepartner'))
});
...
describe("Test suite to validate alelo-enterprisepartner page : ", () => {
    it('Test suite to validate alelo-enterprisepartner page: ', () => {
        ...
        cy.wait(10000);
        cy.percySnapshot('B2B-alelo-enterprisepartner page' + "(" + Cypress.browser.name + "-v" + Cypress.browser.version + ")");
    })
})
